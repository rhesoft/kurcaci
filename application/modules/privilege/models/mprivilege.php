<?php
class Mprivilege extends CI_Model {
    ...
    function insert($kirim){
      $this->db->insert('m_privilege', $kirim); 
      return $this->db->insert_id();
    }
    function update($id, $kirim){
      $this->db->where("id_privilege", $id);
      return $this->db->update("m_privilege", $kirim);
    }
    function get_detail($id){
      $this->db->where("id_privilege", $id);
      return $this->db->get("m_privilege")->row();
    }
    ...
    function get(){
//      $this->db->select('m_users.*, m_status_user.name as status');
...
//      $this->db->order_by("m_users.id_users", "DESC");
      $data = $this->db->get("m_privilege")->result();
      return $data;
    }
