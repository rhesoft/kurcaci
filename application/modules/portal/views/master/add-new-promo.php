        ...
        <div class="box box-primary">
            ...
            <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
              ...
              <div class="box-body">
                ...
                <div class="control-group">
                  <label>Status</label>
                    <?php print $this->form_eksternal->form_dropdown('status', array('1' => "Draft", '2' => "Cancel", '3' => "Aktif", 4 => "Prioritas", 5 => "Pengumuman"), array($detail[0]->status), 'class="form-control input-sm"')?>
                </div>
