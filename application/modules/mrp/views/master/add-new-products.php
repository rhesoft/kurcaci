  ...
  <?php print $this->form_eksternal->form_open_multipart("", 'role="form"', 
    ...
    <div class="box-body">
      ...
      <div class="control-group">
        <label>Company</label>
        <?php 
        print $this->form_eksternal->form_input("portal_company", $this->global_models->get_field("portal_company", "title", array("id_portal_company" => $detail[0]->id_portal_company)), 'id="portal_company" class="form-control input-sm" placeholder="Company"');
